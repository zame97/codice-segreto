...
passport.serializeUser(function(user, done) {
  console.log(user.id); //codice per debuggare
  done(null, user.id);
});
...
const isLoggedIn = (req, res, next) => {      //controlla se sei loggato
  if(req.isAuthenticated())
    next();                               //il next ritorna il risultato alla funzione successiva
  else
    res.redirect('/login');
}
